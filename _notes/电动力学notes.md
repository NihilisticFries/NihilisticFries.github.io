...
## 目录
> 1 Maxwell方程组<br> $\quad$ [1.1 真空中Maxwell方程组的归纳](#section1.1)<br> $\quad$ [1.2 Maxwell方程组的对称性](#section1.2)<br> $\quad$ [1.3 介质中的Maxwell方程组](#section1.3) <br>2 静电学 <br> $\quad$ [2.1 静电学基本方程](#section2.1) <br> $\quad$ [2.2 格林函数法](#section2.2) <br> $\quad$ [2.3 静电唯一性定理](#section2.3)<br> $\quad$ [2.4 导体组的静电平衡](#section2.4) <br> $\quad$ [2.5 用分离变量法求解](#section2.5) <br> $\quad$ [2.6 多极展开](#section2.6) <br> 3 静磁学
